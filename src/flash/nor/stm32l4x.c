		...
		uint32_t offset, uint32_t count)
{
	...
	static const uint8_t stm32l4_flash_write_code[] = {
		0x07, 0x68, 0x00, 0x2f, 0x21, 0xd0, 0x45, 0x68, 0x7e, 0x1b, 0x08, 0x2e,
		0xf8, 0xd3, 0x01, 0x26, 0x66, 0x61, 0x2e, 0x68, 0x6f, 0x68, 0x16, 0x60,
		0x57, 0x60, 0x08, 0x35, 0x08, 0x32, 0xbf, 0xf3, 0x4f, 0x8f, 0x26, 0x69,
		0x10, 0x27, 0xfe, 0x40, 0x01, 0x27, 0x3e, 0x42, 0xf9, 0xd1, 0xfa, 0x27,
		0x3e, 0x42, 0x08, 0xd1, 0x8d, 0x42, 0x01, 0xd3, 0x05, 0x46, 0x08, 0x35,
		0x45, 0x60, 0x01, 0x3b, 0x00, 0x2b, 0x02, 0xd0, 0xdc, 0xe7, 0x00, 0x21,
		0x41, 0x60, 0x30, 0x46, 0x00, 0xbe, 0x01, 0x00, 0x00, 0x00
	};
...
static int stm32l4_probe(struct flash_bank *bank)
{
	...
	case 0x460:
		...
		break;
	default:
		LOG_WARNING("VM: Cannot identify target as a STM32L4 family.");
		return ERROR_FAIL;
	}
...
static int get_stm32l4_info(struct flash_bank *bank, char *buf, int buf_size)
{
	...
	case 0x460:
		device_str = "STM32G071_nico";
		break;

	default:
		snprintf(buf, buf_size, "VM: Cannot identify target as a STM32L4\n");
		return ERROR_FAIL;
	}
